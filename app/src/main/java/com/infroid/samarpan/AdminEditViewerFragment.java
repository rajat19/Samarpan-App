...
public class AdminEditViewerFragment extends Fragment implements View.OnClickListener{
    ...
    EditText email, contact, firstname, description, expertise_in, members, contact_work, contact_fax,
    ...
    public AdminEditViewerFragment() {
    ...
    public void getFilledDetails() {
        completeDetail.setEmail(email.getText().toString());
        completeDetail.setContact(contact.getText().toString());
    ...
    public int validateFilledDetails() {
        int flag = 0;
        if (completeDetail.getEmail().isEmpty()) {
            Toast.makeText(getActivity(), "The primary email field is required.", Toast.LENGTH_SHORT).show();
            flag++;
        }
        if (completeDetail.getContact().isEmpty()) {
            Toast.makeText(getActivity(), "The primary contact field is required.", Toast.LENGTH_SHORT).show();
            flag++;
        }
